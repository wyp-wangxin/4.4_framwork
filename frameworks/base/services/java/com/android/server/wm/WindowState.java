...
final class WindowState implements WindowManagerPolicy.WindowState {
    ...
    final IWindow mClient;  //wwxx 应用进程中的 Window 对象
    final int mAppOp;
    ...
    final int mBaseLayer; //wwxx mBaseLayerµÄÖµÊÇ¹Ì¶¨²»±äµÄ£¬Ö»ºÍ´°¿ÚÀàÐÍÓÐ¹Ø.mBaseLayer(³ÆÎªÖ÷Ðò)ÊÇWindowStateµÄ¹¹Ôì·½·¨ÖÐ¸³Öµ
						 /*mBaseLayer = mPolicy.windowTypeToLayerLw(
                   			attachedWindow.mAttrs.type) * WindowManagerService.TYPE_LAYER_MULTIPLIER + WindowManagerService.TYPE_LAYER_OFFSET;
                   			µÈ¼ÛÓë:mBaseLayer =´°¿ÚÀàÐÍ¡Á10000+1000 */
    			
    final int mSubLayer;/*SubLayer(³ÆÎª×ÓÐò)£¬SubLayerÖµÊÇÓÃÀ´ÃèÊöÒ»¸ö´°¿ÚÊÇ·ñÊôÓÚÁíÍâÒ»¸ö´°¿ÚµÄ×Ó´°¿Ú£¬»òÕßËµSubLayerÖµÊÇÓÃÀ´È·¶¨×Ó´°¿ÚºÍ¸¸´°¿ÚÖ®¼äµÄÏà¶ÔÎ»ÖÃµÄ¡£

    					 mSubLayerµÄ×÷ÓÃ£¬×ÓÐòÔ½´ó£¬ÔòÏà¶ÔÆäËûÐÖµÜ´°¿ÚÔ½¿¿Ç°£¬·´Ö®£¬Ô½¿¿ºó£¬Èç¹ûÎª¸ºÊý£¬¾Í´¦ÔÚ¸¸´°¿ÚµÄºóÃæ.
    					 ×ÓÐòÊÇ¸ù¾Ý´°¿ÚÀàÐÍµ÷ÓÃsubWindowTypeToLayerLwÈ·¶¨µÄ£¬subWindowTypeToLayerLwÍ¬ÑùÊÇÔÚWindowµÄ¹¹Ôì·½·¨ÖÐµ÷ÓÃµÄ¡£*/
    ...
    int mLayer;      /*wwxx mLayer£¬±íÊ¾´°¿ÚÔÚ£ÚÖáµÄÎ»ÖÃ£¬mLayerÖµÔ½Ð¡£¬
    			       ´°¿ÚÔ½¿¿ºó£¬mLayerÖµÔ½´ó£¬´°¿ÚÔ½¿¿Ç°£¬
    			       ×îÇ°ÃæµÄÒ»¸ö´°¿Ú¾Í×÷Îª½¹µã´°¿Ú£¬¿ÉÒÔ½ÓÊÕ´¥ÃþÊÂ¼þ.
    			       mLayerÊÇÍ¨¹ýWindowStateµÄÁíÒ»¸ö³ÉÔ±±äÁ¿mBaseLayerµÄÖµ¼ÆËãµÃµ½£¬
    			       mBaseLayerµÄÖµÊÇ¹Ì¶¨²»±äµÄ£¬Ö»ºÍ´°¿ÚÀàÐÍÓÐ¹Ø¡£*/
    boolean mHaveFrame;
    boolean mObscured;
